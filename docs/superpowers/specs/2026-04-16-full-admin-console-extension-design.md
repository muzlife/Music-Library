...
- [2026-04-16-dashboard-and-master-console-redesign-design.md](/Volumes/Works/07.hahahoho/docs/superpowers/specs/2026-04-16-dashboard-and-master-console-redesign-design.md)
...
## Scope
- Shared admin shell in `/Volumes/Works/07.hahahoho/app/static/index.html`
  - top header
  - tab navigation
...
- `#tabCollectibles`
- `#tabOps`
- shared tab/button routing and shell utility areas already handled in `/Volumes/Works/07.hahahoho/app/static/index.html`
