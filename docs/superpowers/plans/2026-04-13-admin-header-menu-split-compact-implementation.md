...
- Modify: `/Volumes/Works/07.hahahoho/.worktrees/admin-density-compact/tests/test_ops_shell_bootstrap.py` (only if a selector collision appears after CSS changes)
