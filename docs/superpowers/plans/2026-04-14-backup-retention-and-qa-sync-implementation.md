...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/app/main.py`
- 필요 시 `/Volumes/Data/Works/07.__PROJECT_SLUG__/app/db.py`
...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/scripts/backup_daily_db.sh`
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/scripts/backup_weekly_full.sh`
...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/scripts/sync_prod_backup_to_qa.sh`
...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/scripts/upload_backup_to_gcs.sh`
- 필요 시 공통 헬퍼 스크립트
...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/templates/launchd/com.muzlife.backup-daily-db.plist`
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/templates/launchd/com.muzlife.backup-weekly-full.plist`
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/deploy/templates/launchd/com.muzlife.qa-sync-weekly.plist`
...
- `/Volumes/Data/Works/07.__PROJECT_SLUG__/docs/macos_qa_prod_runbook.md`
- 필요 시 운영 매뉴얼/체크리스트
